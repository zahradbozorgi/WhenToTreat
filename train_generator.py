...
def get_data(args):
    ...
    if data_name == "lalonde" or data_name == "lalonde_psid" or data_name == "lalonde_psid1":
        ...
        w, t, y = load_bpic(dataroot=args.dataroot, year=19)
        w = w[:, elim_19]
    elif data_name == "bpic22":
        w, t, y, train_ids, val_ids, test_ids = load_bpic(dataroot=args.dataroot, year=22)
    elif data_name == "bpic12":
        w, t, y, train_ids, val_ids, test_ids = load_bpic(dataroot=args.dataroot, year=12)
    ...
    return ites, ate, w, t, y, train_ids, val_ids, test_ids
...
def main(args, save_args=True, log_=True):
    ...
    model = Model(w, t, y,
                  ...
                  train_indexes=train_ids, val_indexes=val_ids, test_indexes=test_ids)
...
def get_args():
    ...
    # dataset
    parser.add_argument("--data", type=str, default="bpic12")  # TODO: fix choices
    parser.add_argument(
